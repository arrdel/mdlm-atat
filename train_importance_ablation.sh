#!/bin/bash
# Importance Estimator Ablation Study - Direct Training Launcher
# Simplified script that directly invokes Hydra without wrapper
# 
# Usage:
#   ./train_importance_ablation.sh full 0,1 500000
#   ./train_importance_ablation.sh frequency_only 0,1 500000
#   ./train_importance_ablation.sh learned_only 0,1 500000
#   ./train_importance_ablation.sh uniform 0,1 500000
...
echo "=========================================="
echo "Importance Estimator Ablation Study"
echo "=========================================="
...
# Set CUDA devices and run training
...
echo "  Command: $PYTHON -m mdlm.main ..."
echo "  Number of GPUs: $NUM_GPUS"
echo "  Global batch size: $GLOBAL_BATCH_SIZE"
echo ""

# Change to project root so Hydra can find configs
cd "$PROJECT_ROOT"

# Run training with Hydra (use relative path from project root)
$PYTHON -m mdlm.main \
